...
namespace ChessV.Games.Abstract
{
	...
	[Game("Generic x16", typeof(Geometry.Rectangular), 12,
		  Template = true)]
	public class Generic__x16: GenericChess
	{
		// *** GAME VARIABLES *** //
		...
		public Generic__x16
			( int nFiles,               // number of files on main part of board
			  Symmetry symmetry ):      // symmetry determining board mirroring/rotation
				base( nFiles, /* num ranks = */ 16, symmetry )
		{
		}
		...
		public override void SetGameVariables()
		{
			...
			PawnMultipleMove.AddChoice( "@2(2,3,4,5,6)", "Pawns can move up to six spaces when on the second rank");
		...
		public override void AddRules()
		{
			...
			// *** PAWN MULTIPLE MOVE *** //
			if( PawnMultipleMove.Value == "@2(2)" || PawnMultipleMove.Value == "@2(2,3)" || PawnMultipleMove.Value == "@2(2,3,4)" || PawnMultipleMove.Value == "@2(2,3,4,5,6)" )
			{
